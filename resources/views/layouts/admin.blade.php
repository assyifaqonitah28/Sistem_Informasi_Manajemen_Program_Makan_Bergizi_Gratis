        ...
        <aside class="sidebar bg-white shadow-lg border-r border-gray-200">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.distributions.index') }}"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition {{ request()->routeIs('admin.distributions.*') ? 'bg-blue-50 text-blue-700 font-semibold' : '' }}">
